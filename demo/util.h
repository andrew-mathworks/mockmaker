...
#define US_BUNDLE_NAME tmp
#define US_Framework_EXPORT
...
#define CppMicroServices_VERSION_MINOR 8
#define CppMicroServices_VERSION_PATCH 4
#define CppMicroServices_VERSION 3.8.4
#define CppMicroServices_VERSION_STR "3.8.4"

#define US_VERSION_MAJOR 3
#define US_VERSION_MINOR 8
#define US_VERSION_PATCH 4
#define US_VERSION 3.8.4
#define US_VERSION_STR "3.8.4"
...
#define US_FRAMEWORK_VERSION_MAJOR 3
#define US_FRAMEWORK_VERSION_MINOR 8
#define US_FRAMEWORK_VERSION_PATCH 4
#define US_FRAMEWORK_VERSION 3.8.4
#define US_FRAMEWORK_VERSION_STR "3.8.4"
...
#define US_FRAMEWORK_SOURCE_DIR "/place/holder"
